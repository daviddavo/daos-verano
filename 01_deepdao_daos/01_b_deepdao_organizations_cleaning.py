...
# rename organizationId to deepdaoOrganizationId
df = df.rename(columns={'organizationId': 'deepdaoOrganizationId'})
...
# reorder columns
df = df[['deepdaoDaoId', 'deepdaoOrganizationId', 'name', 'platformTitle', 'platformId', 'website',
